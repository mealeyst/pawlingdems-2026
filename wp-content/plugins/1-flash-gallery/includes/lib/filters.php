...
//                    $gallery_snippet .= 'settings: "http://devel.ria-master.com/m/87/flip/settings.xml?b=1%26a=1", ';
                    $gallery_snippet .= 'publications: "'.fgallery_get_publ_url($id).'",';
                    $gallery_snippet .= 'style: "'.fgallery_get_pf_style_url().'",';
                    $gallery_snippet .= 'sitepath: "'.FGALLERY_PATH.'",';
                }
