...
<div class="wrap fgallery">
    ...
    <div id="fgallery_settings" class="fgallery_box">
        ...
        <?php echo '<p><span class="lbl">'.__('Server Name:', 'fgallery').'</span>'.$_SERVER['SERVER_NAME']."</p>";
               ...
               echo '<p><span class="lbl">'.__('WordPress version:', 'fagallery').'</span>'.$wp_version;
...
function fgallery_settings_page() {
    if (isset($_POST['fgallery_watermark_field']) && wp_verify_nonce($_POST['fgallery_watermark_field'], 'fgallery_watermark')){
            if( isset( $_POST['watermark_enabled']) ) {
              update_option( '1_flash_gallery_watermark_enabled', 1 );
            }
            else {
              update_option( '1_flash_gallery_watermark_enabled', 0 );
            }

            if( isset( $_POST['preview_opt'] ) ) {
              update_option( '1_flash_gallery_preview_opt', 1 );
            }
            else {
              update_option( '1_flash_gallery_preview_opt', 0 );
            }

            if( isset( $_POST['save_or_opt'] ) ) {
              update_option( '1_flash_gallery_save_original', 1 );
            }
            else {
              update_option( '1_flash_gallery_save_original', 0 );
            }

            if( isset( $_POST['wm_placement'] ) ) {
              update_option( '1_flash_gallery_watermark_place', $_POST['wm_placement'] );
            }
            else {
              update_option( '1_flash_gallery_watermark_place', 'BR' );
            }
    ...
    <form id="fgallery_watermark_form" method="post" enctype="multipart/form-data">
        <fieldset>
            ...
            <fieldset>
                ...
                <?php $access = get_option('1_flash_gallery_access_level','manage_options') ?>                                
                ...
                <select name="access_level" id="access_level">
                    ...
                    <option value="manage_options" <?php if ($access == 'manage_options') echo 'selected="selected"'?>>
