	...
	public function render_content() {
		...
		switch ( $this->type ) {
			...
			case 'icon' :
				...
				<div class="hoot-customizer-control-icon-picked hoot-flypanel-button" data-flypaneltype="icon"><i class="<?php echo esc_attr( $iconvalue ) ?>"></i><span><?php esc_html_e( 'Select Icon', 'dispatch' ) ?></span></div>
				<div class="hoot-customizer-control-icon-remove"><i class="fas fa-ban"></i><span><?php esc_html_e( 'Remove Icon', 'dispatch' ) ?></span></div>
	...
	<div id="hoot-flyicon" class="hoot-flypanel">
		<div class="hoot-flypanel-header hoot-flypanel-nav">
			<div class="primary-actions">
				<span class="hoot-flypanel-back" tabindex="-1"><span class="screen-reader-text"><?php esc_html_e( 'Back', 'dispatch' ) ?></span></span>
			</div>
		</div>
