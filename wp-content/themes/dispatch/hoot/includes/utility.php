 ...
 *
 * (array)Hoot_Options_Helper::get_terms( 0, 'product_cat' ) => doesnt work in register widget class, most likely due to action heirarchy (i.e. 'widgets_init').
 ...
 */
if ( !function_exists( 'hoot_options_helper_products_category' ) ):
function hoot_options_helper_products_category(){
	...
	return (array)Hoot_Options_Helper::get_terms( 0, 'product_cat' );
}
endif;